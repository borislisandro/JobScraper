...
export type JobFilter={title:string;keyword:string;sort:"recent"|"posted";savedOnly:boolean;includeClosed:boolean;postedWithinDays:number|null;sourceIds:string[];countries:string[];includeUnknownLocations:boolean};
...
export type BackgroundSyncStatus={enabled:boolean;requested:boolean;debugBuild:boolean};
...
export type LaunchAtLoginStatus={enabled:boolean;debugBuild:boolean};
