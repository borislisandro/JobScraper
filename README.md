...
| Source orchestration/security source | Stable dated 18-active-plus-reference starter pack, adapter manifests/probe, manual two-domain grouped Scrape All, DNS/IP/redirect guard, 1.5–3.0 second worker jitter, random-nonce authenticated browser sessions, and worker Resume/Cancel protocol source. Node fixture tests cover private targets/non-HTTP; Rust orchestration and Windows headed flow remain link-unexecuted. |
